    ...
    <>
      <div
        ...
        className={`group bg-white rounded-xl border transition-all ${
          isDragging
            ? 'border-violet-300 shadow-xl shadow-violet-100 ring-2 ring-violet-300 ring-offset-1'
            : isFullyDone
      ...
      >
        ...
        <div className="flex items-start gap-2 sm:gap-3 p-3 sm:p-3.5">
          ...
          <div
            {...attributes}
            {...listeners}
            className="flex-shrink-0 mt-1 cursor-grab active:cursor-grabbing touch-none p-0.5 rounded hover:bg-slate-100 transition-colors"
