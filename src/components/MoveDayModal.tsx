                  ...
                  >
                    <div
                      className={`w-9 h-9 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                        isSourceDay ? 'bg-slate-200' : isSelected ? 'bg-violet-500' : 'bg-slate-100'
                      }`}
                    >
                    ...
                    {isSelected && !isSourceDay && (
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-violet-500 flex-shrink-0">
